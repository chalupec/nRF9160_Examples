...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SMS_SEND_PHONE_NUMBER, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SMS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SMS_SUBSCRIBERS_MAX_CNT, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SMS_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SMS_LOG_LEVEL, 3);
