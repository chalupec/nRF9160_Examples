...
struct _isr_table_entry __sw_isr_table _sw_isr_table[65] = {
	...
	{(const void *)0x45e7d, (ISR)0x50a11}, /* 42 */
	...
	{(const void *)0x45ca1, (ISR)0x50a11}, /* 49 */
