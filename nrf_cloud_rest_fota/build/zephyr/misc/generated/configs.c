...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_REST_FOTA_SAMPLE_VERSION, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_REST_FOTA_JOB_CHECK_RATE_MIN, 15);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_REST_FOTA_ENABLE_LED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_REST_FOTA_LED_NUM, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_REST_FOTA_BUTTON_EVT_NUM, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BUILD_S1_VARIANT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_S1_VARIANT_IMAGE_NAME, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FOTA_DL_TIMEOUT_MIN, 30);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_REST_FOTA_DL_TIMEOUT_MIN, 30);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_CLOUD_FOTA_POLL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_CLOUD_FOTA_POLL_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_CLOUD_FOTA_POLL_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DOWNLOAD_CLIENT_STACK_SIZE, 1280);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AT_HOST_STACK_SIZE, 2048);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_CLOUD_REST_FOTA_SAMPLE_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_CLOUD_REST_FOTA_SAMPLE_LOG_LEVEL, 3);
