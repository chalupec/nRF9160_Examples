...
struct _isr_table_entry __sw_isr_table _sw_isr_table[65] = {
	...
	{(const void *)0x11a51, (ISR)0x18a2d}, /* 42 */
	...
	{(const void *)0x11951, (ISR)0x18a2d}, /* 49 */
