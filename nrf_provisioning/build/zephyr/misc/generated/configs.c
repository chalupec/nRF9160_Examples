...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_PROVISIONING_INTERVAL_S, 86400);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_PROVISIONING_CODEC_AT_CMD_LEN, 1792);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_PROVISIONING_CODEC_RX_SZ_START, 1024);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_PROVISIONING_SAMPLE_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_PROVISIONING_SAMPLE_LOG_LEVEL, 3);
